    ...
    <section className='h-auto bg-[var(--background-white)] w-full' id="resume">
      <div className="w-full mx-auto pt-20 pb-12">
        ...
        <div className="resume-content max-w-screen-2xl mx-auto mt-15 xl:mt-20 grid grid-rows-1 lg:grid-cols-2 grid-cols-1 gap-8 lg:gap-15">
          <div className="resume-education mx-8 lg:mx-4">
            ...
            {Education.map((education) => (
              <div className="border border-[var(--color-border)] my-6 rounded-lg" key={education.id}>
                <div className="m-5">
          ...
          <div className="resume-experience mx-8 lg:mx-4">
            ...
            {Experience.map((experience) => (
              <div className="border border-[var(--color-border)] my-6 rounded-lg" key={experience.id}>
                <div className="m-5">
        ...
        <div className="flex justify-center mt-10">
          <a href="/personal-portfolio/Ali-Raza-Resume.pdf" download><button className="hover:bg-[var(--button-color)] text-[var(--button-color)] font-bold hover:text-white border-2 border-[var(--button-color)] px-7 py-4 rounded-full cursor-pointer mt-3 text-xs xl:text-[12px] transition-all duration-300">Download Resume </button></a>
        </div>
