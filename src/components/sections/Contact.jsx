...
function Contact() {
  return (
    <section className='contact-main h-auto bg-[var(--background-white)] w-full' id="contact">
        ...
        <div className="contact-content max-w-screen-2xl mx-auto mt-15 xl:mt-20 grid grid-rows-1 grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 place-items-center gap-12">
          ...
          <form className='w-full col-span-2 mz-4'>
            ...
            <div className="mt-6 flex items-center justify-start gap-x-6 mx-6">
              <button className="bg-[var(--text-secondary)] text-white px-7 py-4 rounded-full drop-shadow-lg/25 cursor-pointer mt-3 text-xs xl:text-[12px]">Send Message</button>
            </div>
          </form>
        </div>
