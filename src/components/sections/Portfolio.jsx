...
function Portfolio() {
  ...
  const PortfolioWork = [
    ...
    },
    {
      ...
      Date: '2025',
      UrlLink: 'https://your-quiz-app-link.com/',
      Img: quizapp
    }
  ...
  return (
    <section className='portfolio-main h-auto bg-[var(--background-light)] w-full' id="portfolio">
                      ...
                      <div>
                        ...
                        <div className="details flex flex-col">
                          ...
                          <ul className="space-y-5">
                            <li><h4 className="border-b border-[#98969652] pb-3 font-semibold text-sm lg:text-[12px]">Client: <span className="font-light"> {activeProject.Client} </span> </h4></li>
                            <li><h4 className="border-b border-[#98969652] pb-3 font-semibold text-sm lg:text-[12px]">Technologies: <span className="font-light"> {activeProject.Technologies} </span> </h4></li>
                            <li><h4 className="border-b border-[#98969652] pb-3 font-semibold text-sm lg:text-[12px]">Industry:<span className="font-light"> {activeProject.Industry} </span> </h4></li>
                            <li><h4 className="border-b border-[#98969652] pb-3 font-semibold text-sm lg:text-[12px]">Date: <span className="font-light"> {activeProject.Date} </span> </h4></li>
                            <li><h4 className="border-b border-[#98969652] pb-3 font-semibold text-sm lg:text-[12px]">URL: <span className="font-light text-[var(--text-secondary)]"><a href={activeProject.UrlLink} target="_blank">{activeProject.UrlLink}</a></span> </h4></li>

                            <li className="portfolio-social-icons pb-3 text-lg lg:text-xl space-x-4">
                              <a target="_blank" href="https://www.facebook.com/profile.php?id=100086266104286"><i className="text-[#4c4d4d] transition duration-250 hover:text-[#4267B2] bi bi-facebook"></i></a>
                              <a target="_blank" href="https://www.instagram.com/m.ali._.raza/"><i className="text-[#4c4d4d] transition duration-250 hover:text-transparent bg-clip-text bg-[radial-gradient(circle_at_30%_107%,#fdf497_0%,#fdf497_5%,#fd5949_45%,#d6249f_60%,#285AEB_90%)] bi bi-instagram "></i></a>
                              <a target="_blank" href="https://www.linkedin.com/in/muhammad-ali18/"><i className="text-[#4c4d4d] transition duration-250 hover:text-[#0A66C2] bi bi-linkedin"></i></a>
                              <a target="_blank" href="https://github.com/Muhammad-Ali-16"><i className="text-[#4c4d4d] transition duration-250 hover:text-[#24292e] bi bi-github"></i></a>
                            </li>
                          </ul>
                        </div>
                      </div>
