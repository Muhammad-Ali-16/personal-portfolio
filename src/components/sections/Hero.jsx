      ...
      <div className="relative max-w-7xl mx-auto">
        <div className='hero-content'>
          ...
          <a href="https://www.linkedin.com/in/muhammad-ali18/" target='_blank'>
            <button
              className='transition-all ease-in-out duration-200 my-3 border-2 border-[var(--text-secondary)] px-8 lg:px-10 py-2 lg:py-3 rounded-full font-bold text-[var(--text-secondary)] cursor-pointer hover:text-[var(--text-heading-light)] hover:bg-[var(--text-secondary)]'>
              Hire Me</button>
          </a>
        </div>
      </div>
