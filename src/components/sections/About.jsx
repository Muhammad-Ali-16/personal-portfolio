          ...
          <div className=" mx-8 lg:mx-28 xl:mx-10 grid grid-rows-1 grid-cols-3">
            ...
            <div className="about-details col-span-full xl:col-span-1 xl:mx-4 mx-0 mt-20 xl:mt-0">
              <ul className="flex flex-col xl:ms-14 ms-0 space-y-6 text-[var(--text-primary)]">
                ...
                <a href="/personal-portfolio/Ali-Raza-Resume.pdf" download><button className="bg-[var(--text-secondary)] text-white px-7 py-4 rounded-full drop-shadow-lg/25 cursor-pointer mt-3 text-xs xl:text-[12px]">Download Resume</button></a>
              </ul>
            </div>
          </div>
        </div>
