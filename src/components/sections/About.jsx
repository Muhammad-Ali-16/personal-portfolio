...
function About() {
  return (
    <section className='about-main h-auto bg-[var(--background-white)] w-full' id="about">
      <div className="max-w-7xl mx-auto pt-20 pb-12">
        <SectionHeading Heading={"About Me"} SubHeading={"Know Me More"} />
        <div className="about-content max-w-7xl mx-auto mt-15 xl:mt-20">
          <div className=" mx-8 lg:mx-28 xl:mx-10 grid grid-rows-1 grid-cols-3">
            <div className="about-about text-center xl:text-start col-span-full xl:col-span-2">
