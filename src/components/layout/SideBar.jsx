...
function SideBar() {
  ...
  return (
    <nav className="w-[235px] fixed bg-[var(--background-dark)] h-full overflow-hidden overflow-y-auto hidden xl:block left-0 top-0 z-10">
      <div className="mx-auto p-2 h-full flex flex-col items-center justify-between text-center text-[var(--text-heading-light)]">
        ...
        <div className='nav-icons mt-12 space-x-5 text-lg mb-3'>
          <SocialIcons />
        </div>
